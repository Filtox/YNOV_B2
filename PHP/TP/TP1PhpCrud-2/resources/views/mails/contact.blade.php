	...
	<div style="background-color:#333333;">
		...
		<div style="background:#cc0000;background-color:#cc0000;margin:0px auto;max-width:600px;">
			<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
				style="background:#cc0000;background-color:#cc0000;width:100%;">
				<tbody>
					<tr>
													...
													<tr>
														<td align="center" style="font-size:0px;padding:10px 0;word-break:break-word;">
															<table border="0" cellpadding="0" cellspacing="0" role="presentation"
																...
																<tbody>
																	<tr>
																		<td style="width:150px;"><img alt="logo" height="auto"
													...
													<tr>
														<td align="left" style="font-size:0px;padding:18px 0px;word-break:break-word;">
															<div
																...
																Merci {{ firstname }} pour ton message</div>
														</td>
													</tr>
												</table>
											</td>
											...
											<td style="vertical-align:top;padding:0px;">
												<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
													<tr>
														<td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
															<table border="0" cellpadding="0" cellspacing="0" role="presentation"
																...
																<tbody>
																	<tr>
																		<td style="width:192px;"><img alt="tickets" height="auto"
													...
													<tr>
														<td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
															<div
																style="font-family:Lato, Helvetica, Arial, sans-serif;font-size:25px;line-height:1;text-align:center;color:#FAB701;">
																<strong>Salut {{ FirstName }}<br><br>j'ai bien reçu ton message, je te recontacte le plus
																	rapidement possible</strong></div>
														</td>
													</tr>
													<tr>
														<td align="center" style="font-size:0px;padding:10px 30px;word-break:break-word;">
															<div
																style="font-family:Lato, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#EC652D;">
																<strong>En attendant voici les photos de mon dernier roadtrip ;)</strong></div>
														</td>
													</tr>
												</table>
											</td>
		...
		<div style="background:#222222;background-color:#222222;margin:0px auto;max-width:600px;">
			<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
				style="background:#222222;background-color:#222222;width:100%;">
				<tbody>
					<tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
													<tr>
														<td align="center" style="font-size:0px;padding:0 25px;word-break:break-word;">
															<table border="0" cellpadding="0" cellspacing="0" role="presentation"
																...
																<tbody>
																	<tr>
																		<td style="width:150px;"><img alt="New York" height="auto"
													...
													<tr>
														<td align="center" vertical-align="top"
															...
															<div
																style="font-family:Lato, Helvetica, Arial, sans-serif;font-size:20px;line-height:1;text-align:center;color:#EC652D;">
																<strong>New York</strong><br></div>
														</td>
													</tr>
												</table>
											</td>
													...
													<tr>
														<td align="center" style="font-size:0px;padding:0 25px;word-break:break-word;">
															<table border="0" cellpadding="0" cellspacing="0" role="presentation"
																...
																<tbody>
																	<tr>
																		<td style="width:150px;"><img alt="London" height="auto"
													...
													<tr>
														<td align="center" style="font-size:0px;padding:0 25px;word-break:break-word;">
															<table border="0" cellpadding="0" cellspacing="0" role="presentation"
																...
																<tbody>
																	<tr>
																		<td style="width:150px;"><img alt="Berlin" height="auto"
												...
												<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
													<tr>
														<td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
															<div
																style="font-family:Lato, Helvetica, Arial, sans-serif;font-size:20px;line-height:1;text-align:center;color:#EC652D;">
																A bientot,<br><br>The {{ Company }} Team</div>
														</td>
													</tr>
												</table>
											</td>
